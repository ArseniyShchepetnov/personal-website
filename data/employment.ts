...
export const employment = [
    {
        ...
        text: "In this  startup I was responsible for the data infrastructure and algorithmic design in the social data and LLM based projects. I prepared data infrastructure and NLP algorithms which work in production environment.",
    ...
    },
    {
        ...
        industry: "MedTech",
        text: "There were two projects that I developed. On the first one I prepared document analysis NLP system. On the other project I produced data synthesis module with generative ML.",
        dates: "Feb 2023 - Sep 2023",
    ...
    },
    {
        ...
        text: "I managed a small team (3-5 persons) on projects related to the AI applications in Oil&Gas industry. It was a full cycle ML development including data engineering, MLOps and Machine Learning Engineering tasks. By the end of my work in the company I was promoted to Manager grade.",
    ...
    },
    {
        ...
        text: "I produced algorithms for wearable devices in application to the heart and blood pressure measurements.",
